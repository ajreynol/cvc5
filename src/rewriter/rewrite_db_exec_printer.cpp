...
void printHeader(std::ostream& os)
{
  os << "/****************************************************************"
        "**************"
     << std::endl;
  os << " * This file is part of the cvc5 project." << std::endl;
  os << " *" << std::endl;
  os << " * Copyright (c) 2009-2026 by the authors listed in the file AUTHORS"
     << std::endl;
  os << " * in the top-level source directory and their institutional "
        "affiliations."
     << std::endl;
  os << " * All rights reserved.  See the file COPYING in the top-level source"
     << std::endl;
  os << " * directory for licensing information." << std::endl;
  os << " * **************************************************************"
        "**************"
     << std::endl;
  os << " *" << std::endl;
  os << " * Compiled implementation of the executable rewrite rules."
     << std::endl;
  os << " *" << std::endl;
  os << " * This file is generated by `-o rare-db-exec` and installed by"
     << std::endl;
  ...
  os << "#include \"util/rational.h\"" << std::endl;
  os << "#include \"util/string.h\"" << std::endl;
  os << std::endl;
  os << "namespace cvc5::internal {" << std::endl;
  os << "namespace rewriter {" << std::endl;
  os << std::endl;
}
